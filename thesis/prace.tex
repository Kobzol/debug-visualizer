...
\label{sec:ExistingDebuggers}
	...
	\subsection{Grafická rozhraní}
		...
		\subsubsection{DDD}
			...
			\InsertFigure{Figures/gui_ddd}{\textwidth}{Rozhraní programu DDD}{fig:GuiDDD}
		...
		\label{ref:clion}
			...
			\InsertFigureSource{Figures/gui_clion}{\textwidth}{Rozhraní programu CLion}{fig:GuiClion}{Zdroj: https://www.jetbrains.com/clion}
		...
		\subsubsection{GDB TUI}
			...
			\InsertFigure{Figures/gui_gdb_tui}{\textwidth}{Textové rozhraní GDB TUI}{fig:GuiGdbTui}
