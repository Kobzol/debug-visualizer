	...
	\subsection{Knihovna pro komunikaci s debuggery}
		...
		\begin{description}
			...
			\begin{description}
				...
				V ní dochází k otevření souboru, pomocí kterého lze komunikovat s komunikačním rozhraním. % TODO: lepší název
				...
				\remark{Pro alokaci a namapování paměti lze využít i systémového volání \textbf{mmap}. Jelikož ale není běžné ho používat v programech explicitně,
			tak toto volání \textit{Devi} nesleduje.}
			\end{description}
