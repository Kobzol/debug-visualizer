...
který vizualizuje pamět a~stav procesu během jeho ladění.}
...
\label{appendix:manual}
	...
	\texttt{matplotlib} a~\texttt{clang}. Pro spuštění testů je potřeba balíček \texttt{pytest} (ve verzi pro Python 2)
